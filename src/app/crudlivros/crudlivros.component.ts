...
@Component({
  selector: 'app-crudlivros',
  templateUrl: './crudlivros.component.html',
  styles: [
    `
  ...
  styleUrls: ['./crudlivros.component.scss'],
})
export class CrudlivrosComponent {
  ...
  constructor(
    private productService: CrudlivrosService,
